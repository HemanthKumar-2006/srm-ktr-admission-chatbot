...
# ================= CONFIG =================
DATA_PATH = Path("backend/data/raw/srm_data.json")
...
def query_rag(question: str) -> str:
    try:
        ...
        if analysis["entities"].get("campus"):
            filters.append({"campus": analysis["entities"]["campus"]})
        ...
        if target_cat:
            filters.append({"category": target_cat})
        ...
        if not filtered:
            return (
                ...
                "Try asking about SRM KTR admissions, fees, courses, or campus life."
            )
